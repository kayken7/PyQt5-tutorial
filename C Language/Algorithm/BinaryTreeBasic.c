...
int main(int argc, char const *argv[])
{
    ...
    // printf("\n[삭제 전]\n");
    // printf("root->data : %d root->right->data: %d root->right->left->data: %d root->right->right->data: %d\n\n", 
    //         root->data, root->right->data, root->right->left->data, root->right->right->data);
    ...
    // printf("root->right->left at 0x%p, data: %d\n", root->right->left, root->right->left->data);
    // printf("root->right->right at 0x%p, data: %d\n", root->right->right, root->right->right->data);
    
    // printf("root->right->left->left  at 0x%p, \n", root->right->left->left);
    // printf("root->right->left->right at 0x%p, \n", root->right->left->right);

    // printf("root->right->right->left at 0x%p, \n", root->right->right->left);
    // printf("root->right->right->right at 0x%p, \n", root->right->right->right);  
